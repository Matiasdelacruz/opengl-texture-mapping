...
int main(int argc, char* argv[]) {
    ...
    char* f_shader_filename = (char*) "./phong-shading-two-sided.f.glsl";
    bmp_filename = (char*) "uvtemplate.bmp";

    if (argc != 5) {
        fprintf(stderr, "Usage: %s model.obj vertex_shader.v.glsl fragment_shader.f.glsl bitmap\n", argv[0]);
    } else {
        obj_filename = argv[1];
